...
public interface AtualizarProprietarioPresenter {
    ...
    AtualizarProprietarioInput atualizarProprietarioRequestEmAtualizarProprietarioInput(String id, AtualizarProprietarioRequest atualizarProprietarioRequest);
