...
public class AtualizarClienteController {
    ...
    private final AtualizarClienteUserCaseFactory atualizarClienteUserCaseFactory;
    ...
    public ResponseEntity<ClienteResponse> atualizar(@PathVariable String id, @RequestBody AtualizarClienteRequest atualizarClienteRequest){
        ...
        var atualizarClienteUserCase = atualizarClienteUserCaseFactory.buidAtualizarClienteUserCase(atualizarClientePresenter, clientePresenter, clienteRepository);
